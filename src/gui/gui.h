...
class FurnaceGUI {
  ...
  String workingDirVGMExport, workingDirZSMExport, workingDirDevSoundExport, workingDirROMExport;
  ...
  void drawExportDevSound(bool onWindow=false);
