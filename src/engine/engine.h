...
class DivEngine {
  ...
  public:
    ...
    SafeWriter* saveMNM(int type, const bool* sysToExport, bool loop, bool patternHints);
    // dump to pattern-only MNM.
    bool saveMNMPattern(SafeWriter* w, const bool* sysToExport, bool loop, bool patternHints);
    // dump to MNS.
